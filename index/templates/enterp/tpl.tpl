                    ...
                    <div id="hrzhiwei">
                		...
                		<div id="hrzhiweimain">
                        	...
                        	<ul>
								...
								<li><span class="glogintext">公司地址：</span>
									 <input name="info[live_address]" id="live_address" class="k" value="<!--{$info.live_address}-->" title="公司地址:空"/><span id="showResult_live_address"></span>
                                </li>
