                                ...
                                <table width="100%" cellspacing="1" cellpadding="0" border="0" id="recordtable" class="listTab">
								  ...
								  <tr class="tabHead">
                                    ...
                                    <tr class="list1" onmouseover="this.style.backgroundColor='#FFE8D2'" onmouseout="this.style.backgroundColor=''">
                                        ...
                                        <td nowrap="" class="action centerAlign"><a class="songDefA" target="_blank" href="/enterp/resume/view.html?id=<!--{$item.id}-->&t=cn&from=boxlist">查看</a> <a href="/enterp/resume/del.do?PositionID=<!--{$item.id}-->&type=box" onclick="if(confirm('确定删除?')==false){return false}else{ return true;}">删除</a></td>
                                        </tr>
