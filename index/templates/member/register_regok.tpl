...
<div class="grid_24">
  <div id="glogin">
    ...
    <div id="gloginright">
      ...
      <div id="gss">
        <ul>
          <li class="font14px bold orange title">您的帐号注册成功！</li>
          <li class="title">欢迎您加入视一视招聘网！您可以操作以下由我们为您提供的服务</li>
          <h3 style="border:none;padding:10px 0 0 0;"><img src="<!--{$baseurl}-->/images/Icon1.gif" /> 我的简历</h3>
          <li>您可以填写中文和英文简历，并选择上传简历的语言</li>
