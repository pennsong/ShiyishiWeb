      ...
      <div id="gcenterrightc">
        ...
        <table width="100%" cellspacing="1" cellpadding="0" id="ftable">
          ...
          <tr>
            ...
            <td><p><!--{$item.apply_date}--></p></td>
            <td><!--{$item.job_expiry_date|date_format:"%Y-%m-%d %H:%M"}--></td>
            <td><a href="<!--{$baseurl}-->/member/do/myjob.do?act=pos&id=<!--{$item.id}-->" target="post_main">删除</a></td>
          </tr>
		  <!--{foreachelse}-->
          <tr>
            <td colspan="6" align="center">暂无任何职位申请记录，立即<a href="<!--{$weburl}-->/jobs.html" target="_blank">查找职位</a></td>
          </tr>
		  <!--{/foreach}-->
          <!--{if $rows}-->
		  <tr>
            ...
            <td colspan="4"><div align="right"><!--{include file=page.tpl}--></div></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
