		...
		<div id="content" class="container_24">
        	<div class="grid_24">
            	<div id="hrlogin">
                	<div id="hrloginleft">
                    	<ul>
                        	<li>联系我们请拨打:<br />400-888-8888<br />800-8888888</li>
                        </ul>
                    </div>
                    <div id="hrloginright">
                    	<h2></h2>
                        ...
                        <ul>
                       	    <li><span class="hrlogintext">单位名称：</span><input class="k" name="info[company]" id="company" type="text" alt="单位名称:空"/><span id="showResult_company"></span></li>
                       	    <li><span class="hrlogintext">联系人：</span><input class="k" name="info[contact]" id="contact"  type="text" alt="联系人:空"/><span id="showResult_contact"></span></li>
                        	<li><span class="hrlogintext">固定电话：</span><input class="k" name="info[tel]" id="tel"  type="text" alt="固定电话:空/电话" /><span id="showResult_tel"></span></li>
                        	<li><span class="hrlogintext">手机：</span><input class="k" name="info[mobile]"  id="mobile" type="text" alt="手机:空/手机" /><span id="showResult_mobile"></span></li>
                        	<li><span class="hrlogintext">邮箱：</span><input class="k" name="info[email]"  id="email" type="text" alt="邮箱:空/邮箱" /><span id="showResult_email"></span></li>
                        	...
                        	<li><span class="hrlogintext">&nbsp;</span>传真号码xxxxx</li>
