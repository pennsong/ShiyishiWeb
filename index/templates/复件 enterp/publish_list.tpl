                    ...
                    <div id="hrzhiweilist">
                        ...
                        <div id="fengge">
                            ...
                            <ul id="tabs">
                              ...
                              <li><a <!--{if $t==2 || !$t}-->class="current"<!--{/if}--> href="/enterp/publish_job/list.do?<!--{if $sub}-->sub=<!--{$sub}-->&<!--{/if}-->t=2">即将到期职位</a></li>
                              <li><a <!--{if $t==3 || !$t}-->class="current"<!--{/if}--> href="/enterp/publish_job/list.do?<!--{if $sub}-->sub=<!--{$sub}-->&<!--{/if}-->t=3">已暂停职位</a></li>
                              <li><a <!--{if $t==4 || !$t}-->class="current"<!--{/if}--> href="/enterp/publish_job/list.do?<!--{if $sub}-->sub=<!--{$sub}-->&<!--{/if}-->t=4">发布结束职位</a></li>
									...
									<!--{foreach from=$jobs key=key item=item}-->
										<tr class="list2" onmouseover="this.style.backgroundColor='#FFE8D2'" onmouseout="this.style.backgroundColor=''">
											...
											<td nowrap="" class="action centerAlign">
												<a  href="/jobs/view/<!-{$item.id}->.html" target="_blank">预览</a> 
