...
<ul class="nav3">
<li><a href="<!--{$pageurl}-->/index.do" class="btn2"><span>类别管理</span></a></li>
<!--{if $info.id}-->
<li><a href="#" class="btn1"><span>修改分类</span></a></li>
<!--{else}-->
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
		<td colspan="2" class="td1">上级类别:</td>
	</tr>
	<tr class="tr4">
		<td class="td2">
	...
	<tr>
		<td colspan="2" class="td1">类别名称:</td>
	</tr>
	<tr class="tr4">
