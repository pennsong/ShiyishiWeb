...
<ul class="nav3">
<li><a href="<!--{$pageurl}-->/index.do" class="btn2"><span>行业管理</span></a></li>
<!--{if $info.id}-->
<li><a href="#" class="btn1"><span>修改行业</span></a></li>
<!--{else}-->
<li><a href="#" class="btn1"><span>添加行业</span></a></li>
<!--{/if}-->
</ul>
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr class="tr4">
		...
		<td class="td4">
			<select name="info[parent_id]">
				...
				<!--{foreach from=$dustrytypes item=dustrytype}-->
				<option value="<!--{$dustrytype.id}-->"<!--{if $dustrytype.id == $info.parent_id}--> selected<!--{/if}-->><!--{$dustrytype.thename}--></option>
				<!--{/foreach}-->
			</select>
		</td>
	</tr>
	<tr class="tr4">
		...
		<td class="td4"><input type="text" id="thename" class="input" name="info[thename]" value="<!--{$info.thename}-->" alt="行业名称:4-50/无内容/有全角/有空格"/>
