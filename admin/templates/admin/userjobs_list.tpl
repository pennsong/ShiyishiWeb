...
<form id="listform" name="listform" action="<!--{$pageurl}-->/removejobs.do" method="post" target="post_main">
<table cellspacing="0" cellpadding="0" width="100%" id="ftable">
  ...
  <tr class="tr3">
    ...
    <td>
	<a class="fourm-two" href="<!--{$pageurl}-->/removejobs.do?cid=<!--{$cid}-->&id=<!--{$item.id}-->" onclick="return confirm('确定删除该用户吗?删除后不可恢复')" target="post_main">彻底删除</a>
	</td>
  </tr>
  <!--{/foreach}-->
</table>
