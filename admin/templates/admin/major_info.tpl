...
<ul class="nav3">
<li><a href="<!--{$pageurl}-->/index.do" class="btn2"><span>专业管理</span></a></li>
<!--{if $info.id}-->
<li><a href="#" class="btn1"><span>修改专业</span></a></li>
<!--{else}-->
<li><a href="#" class="btn1"><span>添加专业</span></a></li>
<!--{/if}-->
</ul>
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr class="tr4">
		...
		<td class="td4">
			<select name="info[parent_id]">
				...
				<option value="<!--{$major.id}-->"<!--{if $major.id == $info.parent_id}--> selected<!--{/if}-->><!--{$major.thename}--></option>
				<!--{/foreach}-->
			</select>
		</td>
	</tr>
	<tr class="tr4">
		...
		<td class="td4"><input type="text" id="thename" class="input" name="info[thename]" value="<!--{$info.thename}-->" alt="专业名称:4-50/无内容/有全角/有空格"/>
