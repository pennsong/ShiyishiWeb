 ...
 */
    ...
    function trigger_error($error_msg, $error_code = 500)
    {
        ...
        //trigger_error("Smarty error: $error_msg", $error_code);
    }
   ...
   /**
    ...
    function _fetch_resource_info(&$params)
    {
        ...
        if (!$_return) {
            if (!$params['quiet']) {
                $this->trigger_error('unable to read resource: "' . $params['resource_name'] . '"',404);
            }
    ...
    function _trigger_fatal_error($error_msg, $tpl_file = null, $tpl_line = null,
            $file = null, $line = null, $error_code = 500)
    {
        ...
        if (isset($tpl_line) && isset($tpl_file)) {
            $this->trigger_error('[in ' . $tpl_file . ' line ' . $tpl_line . "]: $error_msg$info", $error_code);
        } else {
            $this->trigger_error($error_msg . $info, $error_code);
        }
    }
